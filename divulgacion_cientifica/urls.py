...
urlpatterns = [
    ...
    url(r'^articulos-divulgacion/json2/', ArticuloDivulgacionJSON.as_view(), name='articulo_divulgacion_lista__json'),
    url(r'^articulos-divulgacion/json2-otros/', ArticuloDivulgacionJSON.as_view(otros=True), name='articulo_divulgacion_lista_otros__json'),
    ...
    url(r'^libros-divulgacion/json2/', LibroDivulgacionJSON.as_view(), name='libro_investigacion_lista__json'),
    url(r'^libros-divulgacion/json2-otros/', LibroDivulgacionJSON.as_view(otros=True), name='libro_investigacion_lista_otros__json'),
    ...
    url(r'^capitulos-libros-divulgacion/json2/', CapituloLibroDivulgacionJSON.as_view(), name='capitulo_libro_divulgacion_lista__json'),
    url(r'^capitulos-libros-divulgacion/json2-otros/', CapituloLibroDivulgacionJSON.as_view(otros=True), name='capitulo_libro_divulgacion_lista_otros__json'),
    ...
    url(r'^organizacion-eventos-divulgacion/json2/', OrganizacionEventoDivulgacionJSON.as_view(), name='organizacion_evento_divulgacion_lista__json'),
    #url(r'^organizacion-eventos-divulgacion/json2-otros/', OrganizacionEventoDivulgacionJSON.as_view(otros=True), name='organizacion_evento_divulgacion_lista_otros__json'),
    ...
    url(r'^participacion-eventos-divulgacion/json2/', ParticipacionEventoDivulgacionJSON.as_view(), name='participacion_evento_divulgacion_lista__json'),
    url(r'^participacion-eventos-divulgacion/json2-otros/', ParticipacionEventoDivulgacionJSON.as_view(otros=True), name='participacion_evento_divulgacion_lista_otros__json'),
    ...
    url(r'^medios-divulgacion/json2/', ProgramaRadioTelevisionInternetJSON.as_view(), name='programa_radio_television_internet_lista__json'),
