...
urlpatterns = [
    ...
    url(r'^rest/eventos-divulgacion/$', RESTEventoDivulgacionLista.as_view()),
    url(r'^rest/eventos-divulgacion/(?P<pk>[0-9]+)/$', RESTEventoDivulgacionDetalle.as_view()),

    url(r'^eventos-divulgacion/agregar/$', EventoDivulgacionAgregar.as_view(), name='institucion_agregar'),
    url(r'^eventos-divulgacion/(?P<pk>[\w\-]+)/$', EventoDivulgacionDetalle.as_view(), name='institucion_detalle'),
]