...
urlpatterns = [
    url(r'^academicos/json2/', DistincionAcademicoJSON.as_view(), name='distincion_academico_lista__json'),
    ...
    url(r'^alumnos/json2/', DistincionAlumnoJSON.as_view(), name='distincion_alumno_lista__json'),
    url(r'^alumnos/json2-otros/', DistincionAlumnoJSON.as_view(otros=True), name='distincion_alumno_lista__json_otros'),
    ...
    url(r'^comisiones-expertos/json2/', ParticipacionComisionExpertosJSON.as_view(), name='comision_expertos_lista__json'),
    ...
    url(r'^sociedades-cientificas/json2/', ParticipacionSociedadCientificaJSON.as_view(), name='sociedad_cientifica_lista__json'),
    ...
    url(r'^citas-publicaciones/json2/', CitaPublicacionJSON.as_view(), name='cita_publicacion_lista__json'),
    url(r'^citas-publicaciones/json2-otros/', CitaPublicacionJSON.as_view(otros=True), name='cita_publicacion_lista__json_otros'),
