...
urlpatterns = [
    ...
    url(r'^memorias-in-extenso/json2/', MemoriaInExtensoJSON.as_view(), name='memoria_in_extenso_lista__json'),
    url(r'^memorias-in-extenso/json2-otros/', MemoriaInExtensoJSON.as_view(otros=True), name='memoria_in_extenso_lista_otros__json'),
    ...
    url(r'^resenas/json2/', ResenaJSON.as_view(), name='resena_lista__json'),
    url(r'^resenas/json2-otros/', ResenaJSON.as_view(otros=True), name='resena_lista_otros__json'),
    ...
    url(r'^traducciones/json2/', TraduccionJSON.as_view(), name='traduccion_lista__json'),
    url(r'^traducciones/json2-otros/', TraduccionJSON.as_view(otros=True), name='traduccion_lista_otros__json'),
    ...
    url(r'^organizacion-eventos-academicos/json2/', OrganizacionEventoAcademicoJSON.as_view(), name='organizacion_evento_academico_lista__json'),
    #url(r'^organizacion-eventos-academicos/json2-otros/', OrganizacionEventoAcademicoJSON.as_view(otros=True), name='organizacion_evento_academico_lista_otros__json'),
    ...
    url(r'^participacion-eventos-academicos/json2/', ParticipacionEventoAcademicoJSON.as_view(), name='participacion_evento_academico_lista__json'),
    url(r'^participacion-eventos-academicos/json2-otros/', ParticipacionEventoAcademicoJSON.as_view(otros=True), name='participacion_evento_academico_lista_otros__json'),
