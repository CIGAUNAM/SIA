...
urlpatterns = [
    ...
    url(r'^desarrollos-tecnologicos/json2/', DesarrolloTecnologicoJSON.as_view(), name='desarrollo_tecnologico_lista__json'),
    url(r'^desarrollos-tecnologicos/json2-otros/', DesarrolloTecnologicoJSON.as_view(otros=True), name='desarrollo_tecnologico_lista__json_otros'),
    ...
    url(r'^licencias/json2/', LicenciaJSON.as_view(), name='licencia_lista__json'),
