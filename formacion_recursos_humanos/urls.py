...
urlpatterns = [
    ...
    url(r'^supervision_investigadores_postdoctorales/json/', SupervisionInvestigadorPostDoctoralJSON.as_view(), name='asesor_estancia_lista__json'),
    url(r'^supervision_investigadores_postdoctorales/$', SupervisionInvestigadorPostDoctoralLista.as_view(), name='asesor_estancia_lista'),
