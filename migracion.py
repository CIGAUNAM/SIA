...
Usuarios = (
    ...
    ('alejandro.velazquez', 'Alejandro', 'Velázquez Montes', 'OTRO', Pais.objects.get(nombre='México').id,
     Ciudad.objects.get(nombre='Morelia').id, '-', '00001'),
...
Usuarios = (
    ...
    ('antonio.larrazabal', 'Larrazábal De la Vía', 'Antonio', 'OTRO', Pais.objects.get(nombre='México').id,
     Ciudad.objects.get(nombre='Morelia').id, '-', 'a.larrazabal'),
...
for i in Maestrias:
    m = Maestria(programa=ProgramaMaestria.objects.get(nombre=i[0]), institucion=Dependencia.objects.get(nombre=i[8][0]).institucion,
...
experiencias = (
    ('Ningúno', False, False, 'Diseñador Instruccional Y Tutor Universidad Virtual Michoacán', False,
    ...
    ('Ningúno', False, False, False, 'Subdirectora de Sistemas de Información Geográfica',
     'Instituto Nacional de Ecología y Cambio Climático (INECC)', 2000, 2, 2005, 9, 'J8YEd'),
    ('Ningúno', False, False, False, 'Jefe de Departamento de Migración Interna',
    ...
    ('Ningúno', False, False, False, 'Colaborador', 'Instituto para el Desarrollo Sustentable en Mesoamérica, A.C.',
     1997, 5, 1997, 7, 'J8YEd'),
    ...
    ('Ningúno', False, False, False, 'Técnico de investigación', 'Universidad Autónoma de Baja California', 2012, 10,
     2014, 2, 'hnSDn'),
    ...
    ('Ningúno', False, False, 'Subdirector de Estudios del Medio Biofísico', False,
    ...
    ('Ningúno', False, 'Catedrático CONACYT', False, False, 'Centro de Investigaciones en Geografía Ambiental (CIGA)',
     2014, 10, 0, 0, 'Yl5I4'),
    ('Ningúno', False, 'Investigador Postdoctoral', False, False,
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 2014, 9, 0, 0, 'EeGJW'),
    ('Ningúno', False, False, False, 'Levantamiento y elaboración de mapas de suelos',
     'Instituto Cartográfico y Geológico de Cataluña', 2008, 10, 2009, 7, 'EeGJW'),
    ('Ningúno', False, False, False, 'Plan de mejora de los caminos rurales de Catalunya',
    ...
    ('Ningúno', False, False, False, 'Miembro de la Mesa Directiva del Colegio del Personal Académico',
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 2007, 11, 2011, 10, 'fEVor'),
    ('Ningúno', False, False, False, 'Representante de los técnicos académicos ante el Consejo Interno',
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 2007, 10, 2011, 10, 'fEVor'),
    ('Ningúno', False, False, False, 'Corresponsable del Proyecto de Creación de la Licenciatura en Geohistoria',
    ...
    ('Ningúno', False, False, False, 'Miembro del Comité de Publicaciones, representante del Área de Ciencias Sociales',
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 1900, 1, 0, 0, 'fEVor'),
    ('Ningúno', False, False, False, 'Editor Académico del Comité Editorial',
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 1900, 1, 0, 0, 'fEVor'),
    ('Ningúno', False, False, False, 'Representante académico ante el Comité Académico del Posgrado en Geografía',
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 2015, 10, 0, 0, 'fEVor'),
    ('Ningúno', False, False, 'Coordinador de la Licenciatura en Geohistoria', False,
     'Escuela Nacional de Estudios Superiores, Unidad Morelia (ENES Morelia)', 2012, 4, 2015, 2, 'fEVor'),
    ('Ningúno', False, False, 'Jefe del Departamento de Docencia', False,
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 2015, 10, 0, 0, 'fEVor'),
    ...
    ('Ningúno', False, False, False, 'Otro', 'Consejo Nacional de Investigaciones Científicas y Técnicas (CONICET)',
     2009, 4, 2014, 3, 'h8fvn'),
    ('Ningúno', False, False, False, 'Otro', 'Centro de Investigaciones en Geografía Ambiental (CIGA)', 2010, 3, 2015,
     12, 'biabG'),
    ...
    ('Ningúno', False, False, False, 'Encargada del Área de Soporte Técnico', 'CodiNet S.A. DE C.V.', 2007, 9, 2010, 2,
     'biabG'),
    ...
    ('Ningúno', True, False, False,
     'Miembro fundador, por invitación, de la Asociación de Historiadores de las Ciencias y las Humanidades A.C. (HCyH). Asamblea General Constitutiva, celebrada en el Instituto de Geografía, UNAM, el 19 de abril de 2007.',
     'Instituto de Geografía', 2007, 4, 0, 0, 'fEVor'),
    ('Ningúno', False, False, False, 'Miembro regular de la Conference of Latin Americanist Geographers (CLAG).',
     'Conference of Latin Americanist Geographers (CLAG)', 2011, 2, 0, 0, 'fEVor'),
    ('Ningúno', False, False, 'Director de Cooperación Académica', False,
    ...
    ('Ningúno', False, False, False, 'Subdirector de recursos genéticos',
    ...
    ('Ningúno', False, False, False, 'Servicio Profesional en la Unidad de Cómputo',
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 1900, 1, 0, 0, 'c3fhV'),
    ('Ningúno', False, False, False, 'Pasante en desarrollo Web',
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 2008, 8, 2008, 12, 'c3fhV'),
    ('Ningúno', False, False, False, 'Residente Profesional en desarrollo Web',
     'Instituto de Investigaciones en Ecosistemas y Sustentabilidad (IIES)', 2007, 8, 2007, 12, 'c3fhV'),
    ('Ningúno', False, False, False, 'Consultor Externo en Soporte Técnico', 'H. Ayuntamiento de Morelos', 2015, 10,
     2015, 12, 'c3fhV'),
    ('Ningúno', False, False, False, 'Servicio Profesional de apoyo a Control Escolar', 'Telebachillerato Michoacán',
     2013, 1, 2015, 1, 'c3fhV'),
    ('Ningúno', False, False, False, 'Servicio Profesional de apoyo a Control Escolar',
    ...
    ('Ningúno', False, False, False, 'Coordinador de Proyecto',
     'Instituto Nacional de Ecología y Cambio Climático (INECC)', 1995, 2, 1996, 2, 'ftTrS'),
    ('Ningúno', False, False, False, 'Technical Officer', 'Commission for Environmental Cooperation', 1996, 2, 1998, 10,
     'ftTrS'),
    ('Ningúno', False, 'Cátedras CONACYT', False, False, 'Consejo Nacional de Ciencia y Tecnología (CONACYT)', 2014, 10,
     2015, 12, 'Y6pdF'),
    ('Investigador Asociado C, Tiempo Completo', False, False, False, 'Otro',
     'Centro de Investigaciones en Geografía Ambiental (CIGA)', 2016, 1, 0, 0, 'Y6pdF'),
    ('Ningúno', False, False, False, 'Profesor De Maestría En Derecho', 'Universidad Vasco de Quiroga (UVAQ)', 2012, 1,
     0, 0, '16ymf'),
    ('Ningúno', False, False, False, 'Evaluador Del Proyecto',
...
for i in experiencias:
    ...
    if int(i[8]) == 0 and int(i[9]) == 0:
        e = ExperienciaLaboral(institucion=Dependencia.objects.get(nombre=i[8][0]).institucion, dependencia=Dependencia.objects.get(nombre=i[5]),
