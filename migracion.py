...
Usuarios = (
    ...
    ('jovanka.spiric', 'Jovanka', 'Spiric', 'POSTDOCTORADO', Pais.objects.get(nombre='México').id, Ciudad.objects.get(nombre='Morelia').id, '-', 'jovanka.spiric'),
    ('rafael.garcia', 'Rafael', 'García Ruíz', 'POSTDOCTORADO', Pais.objects.get(nombre='México').id, Ciudad.objects.get(nombre='Morelia').id, '-', 'rafael.garcia'),
    ('montserrat.serrano', 'Montserrat', 'Serrano Medrano', 'POSTDOCTORADO', Pais.objects.get(nombre='México').id, Ciudad.objects.get(nombre='Morelia').id, '-', 'montserrat.serrano'),
)
