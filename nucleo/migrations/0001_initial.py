    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from='nombre_libro', unique=True)),
                ('descripcion', models.TextField(blank=True)),
                ('tipo', models.TextField(choices=[('INVESTIGACION', 'Investigación'), ('DIVULGACION', 'Divulgaciòn')], max_length=50)),
                ...
                ('ciudad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nucleo.Ciudad')),
                ('coleccion', models.ForeignKey(blank=True, default=1, on_delete=django.db.models.deletion.CASCADE, to='nucleo.Coleccion')),
