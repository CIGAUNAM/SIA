    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuarios', sortedm2m.fields.SortedManyToManyField(help_text=None, related_name='proyecto_responsables', to=settings.AUTH_USER_MODEL, verbose_name='Responsables')),
            ],
            options={
                'ordering': ['nombre'],
            },
