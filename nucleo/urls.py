...
urlpatterns = [
    url(r'^paises/json2/', PaisJSON.as_view(), name='pais_lista__json'),
    ...
    url(r'^estados/json2/', EstadoJSON.as_view(), name='estado_lista__json'),
    ...
    url(r'^ciudades/json2/', CiudadJSON.as_view(), name='ciudad_lista__json'),
    ...
    url(r'^instituciones/json2/', InstitucionJSON.as_view(), name='institucion_lista__json'),
    ...
    url(r'^programas-licenciatura/json2/', ProgramaLicenciaturaJSON.as_view(), name='programa_licenciatura_lista__json'),
    ...
    url(r'^programas-maestria/json2/', ProgramaMaestriaJSON.as_view(), name='programa_maestria_lista__json'),
    ...
    url(r'^programas-doctorado/json2/', ProgramaDoctoradoJSON.as_view(), name='programa_doctorado_lista__json'),
    ...
    url(r'^revistas/json2/', RevistaJSON.as_view(), name='revista_lista__json'),
    ...
    url(r'^dependencias/json2/', DependenciaJSON.as_view(), name='dependencia_lista__json'),
    ...
    url(r'^departamentos/json2/', DepartamentoJSON.as_view(), name='departamento_lista__json'),
    ...
    url(r'^cargos/json2/', CargoJSON.as_view(), name='cargo_lista__json'),
    ...
    url(r'^areas-especialidad/json2/', AreaEspecialidadJSON.as_view(), name='area_especialidad_lista__json'),
    ...
    url(r'^impactos-sociales/json2/', ImpactoSocialJSON.as_view(), name='impacto_social_lista__json'),
    ...
    url(r'^financiamientos/json2/', FinanciamientoJSON.as_view(), name='financiamiento_lista__json'),
    ...
    url(r'^metodologias/json2/', MetodologiaJSON.as_view(), name='metodologia_lista__json'),
    ...
    url(r'^becas/json2/', BecaJSON.as_view(), name='beca_lista__json'),
    ...
    url(r'^reconocimientos/json2/', ReconocimientoJSON.as_view(), name='reconocimiento_lista__json'),
    ...
    url(r'^tipos-evento/json2/', TipoEventoJSON.as_view(), name='tipo_evento_lista__json'),
    ...
    url(r'^eventos/json2/', EventoJSON.as_view(), name='evento_lista__json'),
    ...
    url(r'^distinciones/json2/', DistincionJSON.as_view(), name='distincion_lista__json'),
    ...
    url(r'^editoriales/json2/', EditorialJSON.as_view(), name='editorial_lista__json'),
    ...
    url(r'^colecciones/json2/', ColeccionJSON.as_view(), name='coleccion_lista__json'),
    ...
    url(r'^asignaturas/json2/', AsignaturaJSON.as_view(), name='asignatura_lista__json'),
    ...
    url(r'^medios-divulgacion/json2/', MedioDivulgacionJSON.as_view(), name='medio_divulgacion_lista__json'),
    ...
    url(r'^personas/json2/', PersonaJSON.as_view(), name='usuario_lista__json'),
    ...
    url(r'^usuarios/json2/', UserJSON.as_view(), name='usuario_lista__json'),
    ...
    url(r'^tipos-curso/json2/', TipoCursoJSON.as_view(), name='tipo_curso_lista__json'),
    ...
    # url(r'^proyectos-arbitrados/json2/', ProyectoArbitradoJSON.as_view(), name='proyecto_arbitrado_lista__json'),
    ...
    # url(r'^convocatorias-arbitraje/json2/', ConvocatoriaArbitrajeJSON.as_view(), name='convocatoria_arbitraje_lista__json'),
