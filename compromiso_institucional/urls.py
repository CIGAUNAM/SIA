...
urlpatterns = [
    ...
    url(r'^labores-directivas-coordinacion/json2/', LaborDirectivaCoordinacionJSON.as_view(), name='labor_directiva_coordinacion_lista__json'),
    ...
    url(r'^representaciones-organos-colegiados-unam/json2/', RepresentacionOrganoColegiadoJSON.as_view(), name='representacion_organo_colegiado_unam_lista__json'),
    ...
    url(r'^comisiones-institucionales-ciga/json2/', ComisionAcademicaJSON.as_view(), name='comision_institucional_lista__json'),
    ...
    url(r'^apoyos-tecnicos/json2/', ApoyoTecnicoJSON.as_view(), name='apoyo_tecnico_lista__json'),
    ...
    url(r'^otras-actividades/json2/', ApoyoOtraActividadJSON.as_view(), name='apoyo_otra_actividad_lista__json'),
    ...
    url(r'^representaciones/json2/', RepresentacionJSON.as_view(), name='representacion_lista__json'),
    ...
    url(r'^comisiones-institucionales/json2/', ComisionJSON.as_view(), name='comisioninstitucional_lista__json'),
    ...
    url(r'^actividades-apoyo/json2/', ActividadApoyoJSON.as_view(), name='actividad_apoyo_lista__json'),
