...
urlpatterns = [
    ...
    url(r'^cursos-especializacion/json2/', CursoEspecializacionJSON.as_view(), name='curso_especializacion_lista__json'),
    ...
    url(r'^licenciaturas/json2/', LicenciaturaJSON.as_view(), name='licenciatura_lista__json'),
    ...
    url(r'^maestrias/json2/', MaestriaJSON.as_view(), name='maestria_lista__json'),
    ...
    url(r'^doctorados/json2/', DoctoradoJSON.as_view(), name='doctorado_lista__json'),
    ...
    url(r'^postdoctorados/json2/', PostDoctoradoJSON.as_view(), name='postdoctorado_lista__json'),
