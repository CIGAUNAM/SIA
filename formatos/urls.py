...
urlpatterns = [
    url(r'^servicio-transporte/json2/', FormatoServicioTransporteJSON.as_view(), name='formato_servicio_transporte_lista__json'),
    ...
    url(r'^licencia-goce-sueldo/json2/', FormatoLicenciaGoceSueldoJSON.as_view(), name='formato_licencia_goce_sueldo__json'),
    ...
    url(r'^pago-viaticos/json2/', FormatoPagoViaticoJSON.as_view(), name='formato_pago_viatico_lista__json'),
