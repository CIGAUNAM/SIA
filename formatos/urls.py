...
urlpatterns = [
    ...
    url(r'^licencia-goce-sueldo/json/', FormatoLicenciaGoceSueldoJSON.as_view(), name='formato_licenciaGoce_sueldo_lista__json'),
    url(r'^licencia-goce-sueldo/$', FormatoLicenciaGoceSueldoLista.as_view(), name='formato_licenciaGoce_sueldo_lista'),
    url(r'^licencia-goce-sueldo/(?P<pk>[\w\-]+)/eliminar$', FormatoLicenciaGoceSueldoEliminar.as_view(), name='formato_licenciaGoce_sueldo_eliminar'),
    url(r'^licencia-goce-sueldo/(?P<pk>[\w\-]+)/$', FormatoLicenciaGoceSueldoDetalle.as_view(), name='formato_licenciaGoce_sueldo_detalle'),
