...
\renewcommand{\labelitemii}{\tiny$\blacksquare$}
    ...
    \begin{enumerate}
        ...
        \item{ \textbf{ FORMACIÓN PROFESIONAL }
            \begin{enumerate}

                {% if licenciaturas %}
                \item[2.1.]{ Estudios profesionales
                      \begin{itemize}
                ...
                \item[2.3.] Cursos de especialización o capacitación \\ (Incluir sólo en el caso de los técnicos académicos.)
