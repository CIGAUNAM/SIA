...
bc_seccion = 'Movilidad académica'

class InvitadoMovilidadContext:
    obj = 'invitado'
    objs = 'invitados'
    Objs = 'Invitados'
    ...
    tabla_mios =  '<script>\n' \
                    ...
                    '       $jquery("#tabla_json").dataTable({\n' \
                                ...
                                '"columns": [\n' \
                                    '{\n' \
                                        '"data": "fields.invitado",\n' \
                                        '"fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {\n' \
                                            '$(nTd).html("<a href=\'/' + str(contexto['url_categoria']) + '/' + str(contexto['url_seccion']) + '/" + oData.pk + "\'>" + oData.fields.invitado + "</a>");\n' \
                                        '}\n' \
                                    '},\n' \
...
class EstanciaMovilidadContext:
    ...
    tabla_mios =  '<script>\n' \
                    ...
                    '       $jquery("#tabla_json").dataTable({\n' \
                                ...
                                '"columns": [\n' \
                                    '{\n' \
                                        '"data": "fields.anfitrion",\n' \
                                        '"fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {\n' \
                                            '$(nTd).html("<a href=\'/' + str(contexto['url_categoria']) + '/' + str(contexto['url_seccion']) + '/" + oData.pk + "\'>" + oData.fields.anfitrion + "</a>");\n' \
                                        '}\n' \
                                    '},\n' \
                                    '{"data": "fields.dependencia"},\n' \
                                    '{"data": "fields.fecha_inicio"},\n' \
...
class SabaticoMovilidadContext:
    obj = 'sabático'
    objs = 'sabáticos'
    Objs = 'Sabáticos'

    url_seccion = 'sabaticos'
