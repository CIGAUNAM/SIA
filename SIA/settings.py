...
EVENTO__AMBITO = (('', '-------'), ('NACIONAL', 'Nacional'), ('INTERNACIONAL', 'Internacional'))
...
ENTIDAD_CLASIFICACION = (('', '-------'), ('ACADEMICA', 'Académica'), ('FEDERAL', 'Gubernamental federal'), ('ESTATAL', 'Gubernamental estatal'), ('MUNICIPAL', 'Gubernamental municipal'), ('PRIVADA', 'Sector privado'), ('NO_LUCRATIVA', 'Sector privado no lucrativo'), ('INTERNACIONAL', 'Internacional'))
