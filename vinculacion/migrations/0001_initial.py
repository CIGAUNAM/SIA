    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participantes', models.ManyToManyField(related_name='convenio_entidad_no_academica_usuarios', to=settings.AUTH_USER_MODEL, verbose_name='Académicos participantes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participantes', models.ManyToManyField(related_name='red_academica_usuarios', to=settings.AUTH_USER_MODEL, verbose_name='Académicos participantes')),
